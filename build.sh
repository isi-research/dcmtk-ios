...
lib_i386=`echo $lib_x86_64 | sed "s/x86_64/i386/g"`
lib=`echo $lib_x86_64 | sed "s/x86_64//g"`

${LIPO} -arch armv7 $lib_armv7 -arch arm64 $lib_arm64 -arch i386 $lib_i386 -arch x86_64 $lib_x86_64 -create -output $lib
done
}

mkdir -p $GLOBAL_OUTDIR/armv7 $GLOBAL_OUTDIR/arm64 $GLOBAL_OUTDIR/i386 $GLOBAL_OUTDIR/x86_64 $GLOBAL_OUTDIR/include/dcmtk
...
xcodebuild -configuration 'MinSizeRel' -sdk 'iphonesimulator' clean build ARCHS="i386" ONLY_ACTIVE_ARCH=NO CONFIGURATION_BUILD_DIR=$IOS_OUTDIR
mv $IOS_OUTDIR/* $GLOBAL_OUTDIR/i386/
...
rm -Rf $GLOBAL_OUTDIR/armv7 $GLOBAL_OUTDIR/arm64 $GLOBAL_OUTDIR/i386 $GLOBAL_OUTDIR/x86_64
